...
const App = () => {
  ...
  useEffect(()=>{
    ...
    // console.log("useEffect ran!.", refreshRef.current);
    return () => {
    ...
    style={{ scrollBehavior: "smooth" }}>
      <div className="flex sticky top-0 h-screen w-max bg-p6">
          <motion.div
            ...
            style={hasScrolled?{transform:"translateX(-12.5%)"}:{x, left:"10%"}}
            initial="hidden"
            animate="visible"
          ...
          {hasScrolled && <div className="w-[15vw] h-screen absolute bg-transparent backdrop-blur-md z-10 box-shadow "></div> }
          <motion.div style={{x}} ref={refreshRef} className="flex relative h-screen w-[350vw]">
